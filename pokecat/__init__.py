...
_OPTIONAL_FIELDS = {"ability": None, "ingamename": None, "gender": None, "form": 0, "item": None, "displayname": None,
                    ...
                    "level": 100, "curr_hp": None, "status": None, "combinations": [], "separations": [], "tags": [], "suppressions": []}
...
def populate_pokeset(pokeset, skip_ev_check=False):
    ...
    if curr_hp is None:
        curr_hp = pokeset["stats"]["hp"]
    if not isinstance(curr_hp, int):
        raise ValueError("curr_hp must be a number.")
    pokeset["curr_hp"] = curr_hp

    # check and populate status
    if pokeset["status"] is not None:
        raise NotImplementedError("assignable status isn't implemented yet.")
    pokeset["status"] = {
        "nonvolatile": {
            "slp": 0,
            "psn": False,
...
def fix_moves(instance):
    ...
    for move in instance["moves"]:
        ...
        if move["name"] == "Hidden Power":
            a, b, c, d, e, f = [ivs[stat] % 2 for stat in
            ...
            "Fire", "Water", "Grass", "Electric", "Psychic", "Ice", "Dragon", "Dark")[
                hp_type]
            u, v, w, x, y, z = [(ivs[stat] >> 1) % 2 for stat in
                                ("hp", "atk", "def", "spe", "spA", "spD")]
        ...
        # special case: Natural Gift. Fix power, type and displayname
            ...
            ng_type, ng_power = gen4data.NATURAL_GIFT_EFFECTS.get(
                instance["item"]["name"], ["Normal", 0])
            move["power"] = ng_power
            move["type"] = ng_type
...
def redact_pokeset_data(pokeset):
    pokeset['displayname'] = '???'
    pokeset['ingamename'] = '???'
    pokeset['setname'] = '???'
    pokeset['shiny'] = False
    ...
    pokeset['happiness'] = 0
    pokeset['level'] = '???'
    pokeset['biddable'] = True
    pokeset['ability']['id'] = 0
    pokeset['ability']['name'] = '???'
    pokeset['ability']['description'] = ''
    pokeset['item']['id'] = 0
    pokeset['item']['name'] = '???'
    pokeset['item']['description'] = ''
    pokeset['ball']['id'] = 0
    pokeset['ball']['name'] = '???'
    pokeset['ball']['description'] = ''
    pokeset['nature']['id'] = 0
    pokeset['nature']['name'] = '???'
    pokeset['nature']['increased'] = None
    pokeset['nature']['decreased'] = None
    pokeset['species']['id'] = 0
    pokeset['species']['name'] = '???'
    pokeset['species']['types'] = ['???']
    pokeset['stats'] = {
        'hp': '???',
        'atk': '???',
        'def': '???',
    ...
    pokeset['species']['basestats'] = pokeset['stats']
    pokeset['species']['color'] = '???'
    pokeset['original_species']['id'] = 0
    pokeset['original_species']['name'] = '???'
    pokeset['original_species']['types'] = ['???']
    pokeset['original_species']['basestats'] = pokeset['stats']
    pokeset['ivs'] = pokeset['stats']
    pokeset['evs'] = pokeset['stats']
    pokeset['rarity'] = 1.0
    pokeset['moves'] = pokeset['moves'][:1]
    pokeset['moves'][0]['id'] = 0
    pokeset['moves'][0]['displayname'] = '???'
    pokeset['moves'][0]['name'] = '???'
    pokeset['moves'][0]['name_id'] = '???'
    pokeset['moves'][0]['category'] = 'Physical'
    pokeset['moves'][0]['type'] = '???'
    pokeset['moves'][0]['pp'] = 0
    pokeset['moves'][0]['pp_ups'] = 0
    pokeset['moves'][0]['power'] = 0
    pokeset['moves'][0]['accuracy'] = 0
    pokeset['tags'] = []
    # Live data
    pokeset['curr_hp'] = '???'
    pokeset["status"] = {
